...
(function () {
  ...
  la(
    ...
    function () {
      ...
      Ga = [
        [window, "keydown", Qa],
        [window, "wheel", Ra],
        [window, "hashchange", Sa],
        [window, "resize", Ta],
        [P, "mousedown", Ua],
        [P, "mouseleave", Va],
        [P, "mouseup", Va],
        [P, "mousemove", Wa],
        [P, "touchstart", Ua, { passive: !1 }],
        [P, "touchcancel", Va],
        [P, "touchend", Va],
        [P, "touchmove", Wa, { passive: !0 }],
        [O, "", Xa],
        [Aa, "", Ya],
        [Ba, "", W],
        [Da, "", Za],
  ...
  function Pa(a) {
    var b = fb.call(a.target, ".spotlight");
    if (b) {
      var c = fb.call(b, ".spotlight-group"),
  ...
  function Ra(a) {
    K && ((a = a.deltaY), 0 > 0.5 * (0 > a ? 1 : a ? -1 : 0) ? bb() : ab());
  }
  function Sa() {
    K && "#spotlight" === location.hash && cb(!0);
  }
  function Za(a) {
    ("boolean" === typeof a ? a : !Q)
      ? Q || ((Q = setInterval(W, va)), f(Da, "on"), ta && hb())
      : Q &&
  ...
  function Va(a) {
    if (B && !C) return (B = !1), ib(a);
    D &&
      C &&
      (Ia(!0, (q / u) * 100),
      (q < -(v / 10) && W()) || (q > v / 10 && Ya()) || Ia(),
      (q = 0),
      (D = !1),
      X());
    B = !1;
  ...
  function Wa(a) {
    if (B) {
      Fa || (Fa = requestAnimationFrame(kb));
      var b = jb(a),
        c = (y * A - u) / 2;
      C = !0;
      q -= pa - (pa = b.x);
  ...
  function kb(a) {
    E ? (a && (Fa = requestAnimationFrame(kb)), X(q, r)) : (Fa = null);
    E = !1;
  }
  function Xa(a) {
    (
  ...
  function Ja(a) {
    ...
    a = T[G - 1];
    if ((c = a.title || a.description)) ka(ya, a.title), ka(za, a.description);
